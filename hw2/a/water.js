...
void main() {
    ...
    float nv = max(1.0 - abs(snoise(vec3(vUv * 200.0, tick))), 0.7);
    // gl_FragColor = vec4(mix(vec3(0.0, 0.0, nv*0.7), envColor.rgb, 0.5), waterAlpha);

    gl_FragColor = vec4(mix(nv * vec3(0.37, 0.62, 0.63), envColor.rgb, 0.5), waterAlpha);
}`;
